...
import AddIngredientForm from "../../components/shop/ingredients/AddIngredientForm.tsx";
import IngredientTable from "../../components/shop/ingredients/IngredientTable.tsx";
import {deleteIngredient, getIngredients} from "../../services/shop/ingredientServices.ts";
...
import AdjustStockModal from "../../components/shop/ingredients/AdjustStockModal.tsx";
...
const IngredientsPage: FC = () => {
    ...
    useEffect(() => {
        const fetchIngredients = async () => {
            ...
            setPageLoading(true);
            try {
                const data = await getIngredients(shopId);
                setIngredients(data);
            } catch (error) {
    ...
    const handleDelete = async (ingredientId: string) => {
        if (window.confirm(`¿Estás seguro de que quieres eliminar este ingrediente?`)) {
            try {
                await deleteIngredient(shopId, ingredientId);
