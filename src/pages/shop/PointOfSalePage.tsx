...
import {getProducts} from "../../services/shop/productServices.ts";
...
import ProductGrid from "../../components/shop/pos/ProductGrid.tsx";
import PromotionGrid from "../../components/shop/pos/PromotionGrid.tsx";
import OrderSummary from "../../components/shop/pos/OrderSummary.tsx";
import VariableIngredientModal from "../../components/shop/pos/VariableIngredientModal.tsx";
import {registerSale} from "../../services/shop/saleServices.ts";
import {getActivePaymentMethods} from "../../services/shop/paymentMethodServices.ts";
import PaymentModal from "../../components/shop/pos/PaymentModal.tsx";
import {getOpenCashSession} from "../../services/shop/cashSessionServices.ts";
import {Link} from "react-router-dom";
import {getActivePromotionsForToday} from "../../services/shop/promotionServices.ts";
import {usePersistentState} from "../../hooks/usePersistentState.ts";
import PendingOrdersTabs from "../../components/shop/pos/PendingOrdersTabs.tsx";
...
const PointOfSalePage: FC = () => {
    ...
    const handleProcessPayment = async (payments: SalePayment[], clientId?: string, clientName?: string) => {
        if (!shopId || !user || !activeOrderId || !openSession || currentOrder.length === 0) return;
        ...
        try {
            await registerSale(shopId, saleData);
