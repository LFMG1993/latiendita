...
import {getShopOrders, updateOrderStatus} from '../../services/shop/orderService';
...
const AdminOrdersPage: FC = () => {
    ...
    const loadOrders = async () => {
        ...
        try {
            const data = await getShopOrders(activeShopId);
            setOrders(data);
        } catch (err) {
            console.error(err);
        } finally {
                                ...
                                <div className="modal-body">
                                    <div className="row mb-4">
                                        ...
                                        <div className="col-md-6 text-md-end mt-3 mt-md-0">
                                            ...
                                            <div className="text-body">{new Date(selectedOrder.createdAt).toLocaleString()}</div>
                                            <div className="mt-2">
