...
import { getPendingDebtPayments, approveDebtPayment, rejectDebtPayment, updateClientCreditLimit } from '../../services/shop/debtPaymentService';
...
const AdminDebtPaymentsPage: FC = () => {
    ...
    const fetchPayments = async () => {
        ...
        setLoading(true);
        try {
            const data = await getPendingDebtPayments(activeShopId);
            setPayments(data);
        } catch (error) {
