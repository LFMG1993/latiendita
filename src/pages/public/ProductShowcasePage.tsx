...
import CartSummaryModal from '../../components/public/CartSummaryModal';
...
// UPDATE: Revisando App.tsx, el tenant context depende de `activeIceCreamShop` del auth store.
// Sin auth, no hay `activeIceCreamShop`.
            ...
            <div className="container py-5 text-center">
                 ...
                 <div className="alert alert-warning d-inline-block text-start">
                    <small>
                        ...
                        Asegúrate de que la colección <code>iceCreamShops/{targetShopId}/productos</code> sea legible públicamente.
                    </small>
                 </div>
                 <br />
