...
import {uploadImageToCloudinary} from '../../services/shared/cloudinaryService.ts';
                            ...
                            <div className="card-body">
                                ...
                                <div className="row mb-3">
                                    ...
                                    <div className="col-sm-9"><p
                                        className="text-muted mb-0">{new Date(user?.createdAt || '').toLocaleString() || 'No disponible'}</p>
                                    </div>
                                </div>
                                <hr/>
                                <div className="row mb-3">
                                    ...
                                    <div className="col-sm-9"><p
                                        className="text-muted mb-0">{new Date(user?.updatedAt || '').toLocaleString() || 'Nunca'}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
