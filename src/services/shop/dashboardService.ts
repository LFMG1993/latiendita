 ...
 */
export const getSalesForPeriod = async (shopId: string, startDate: Date, endDate: Date): Promise<Sale[]> => {
 ...
 */
export const getPurchasesForPeriod = async (shopId: string, startDate: Date, endDate: Date): Promise<Purchase[]> => {
 ...
 */
export const getPurchasesForSession = async (shopId: string, employeeId: string, startTime: Date, endTime: Date): Promise<Purchase[]> => {
    const purchases = await apiClient<Purchase[]>(`/shops/${shopId}/purchases`);
 ...
 */
export const getCashSessionsForPeriod = async (shopId: string, startDate: Date, endDate: Date): Promise<CashSession[]> => {
    const sessions = await apiClient<CashSession[]>(`/shops/${shopId}/cash-sessions?status=closed`);
