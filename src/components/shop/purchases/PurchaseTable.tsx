...
const PurchaseTable: FC<PurchaseTableProps> = ({purchases, onEdit, onDelete}) => {
    ...
    const columns = useMemo(() => [
        columnHelper.accessor('createdAt', {
            header: 'Fecha',
            cell: info => new Date(info.getValue() as string).toLocaleDateString('es-CO') || 'N/A',
        }),
                        ...
                        <div className="row g-3 mb-4">
                            <div className="col-sm-6 col-md-3">
                                <div className="p-3 rounded-3 bg-body-tertiary border text-center h-100">
                                    ...
                                    <div className="fw-bold">{new Date(viewingPurchase.createdAt || '').toLocaleDateString('es-CO')}</div>
                                </div>
                            </div>
                            <div className="col-sm-6 col-md-3">
                                <div className="p-3 rounded-3 bg-body-tertiary border text-center h-100">
