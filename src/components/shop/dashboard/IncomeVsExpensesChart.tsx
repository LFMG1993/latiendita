...
import {getSalesForPeriod, getPurchasesForPeriod} from '../../../services/shop/dashboardService';
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const sales = await getSalesForPeriod(activeShopId, start, end);
                const purchases = await getPurchasesForPeriod(activeShopId, start, end);
        ...
        setLoading(true);
        fetchData();
    }, [activeShopId, activeShop, selectedDate]);
