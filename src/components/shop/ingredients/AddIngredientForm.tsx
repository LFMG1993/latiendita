...
import {addIngredient, updateIngredient} from '../../../services/shop/ingredientServices';
...
const AddIngredientForm: FC<AddIngredientFormProps> = ({shopId, onFormSubmit, ingredientToEdit}) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            if (ingredientToEdit?.id) {
                ...
                await updateIngredient(shopId, ingredientToEdit.id, dataToUpdate);
            } else {
                // Si no, usamos el servicio para añadir uno nuevo
                await addIngredient(shopId, formData);
            }
